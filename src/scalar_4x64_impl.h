...
SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits(const secp256k1_scalar *a,
                                                               unsigned int offset,
                                                               unsigned int count) {
...
SECP256K1_INLINE static unsigned int secp256k1_scalar_get_bits_var(const secp256k1_scalar *a,
                                                                   unsigned int offset,
                                                                   unsigned int count) {
...
SECP256K1_INLINE static int secp256k1_scalar_reduce(secp256k1_scalar *r, unsigned int overflow) {
    ...
    t = (uint128_t)
        r->d[0] + overflow * SECP256K1_N_C_0;
    r->d[0] = (uint64_t) (t & 0xFFFFFFFFFFFFFFFFULL);
    t >>= 64;
    t += (uint128_t)
        r->d[1] + overflow * SECP256K1_N_C_1;
    r->d[1] = (uint64_t) (t & 0xFFFFFFFFFFFFFFFFULL);
    t >>= 64;
    t += (uint128_t)
        r->d[2] + overflow * SECP256K1_N_C_2;
    r->d[2] = (uint64_t) (t & 0xFFFFFFFFFFFFFFFFULL);
    t >>= 64;
    t += (uint64_t) r->d[3];
...
static int secp256k1_scalar_add(secp256k1_scalar *r, const secp256k1_scalar *a, const secp256k1_scalar *b) {
    ...
    r->d[3] = (uint64_t) (t & 0xFFFFFFFFFFFFFFFFULL);
    t >>= 64;
    overflow = (uint32_t) (t + secp256k1_scalar_check_overflow(r));
...
static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {
    ...
    r->d[0] = (uint64_t) (t & nonzero);
    t >>= 64;
    t += (uint128_t)(~a->d[1]) + SECP256K1_N_1;
    r->d[1] = (uint64_t) (t & nonzero);
    t >>= 64;
    t += (uint128_t)(~a->d[2]) + SECP256K1_N_2;
    r->d[2] = (uint64_t) (t & nonzero);
    t >>= 64;
...
static void secp256k1_scalar_reduce_512(secp256k1_scalar *r, const uint64_t *l) {
    ...
    r->d[0] = (uint64_t) (c & 0xFFFFFFFFFFFFFFFFULL);
    c >>= 64;
    c += p1 + (uint128_t)SECP256K1_N_C_1 * p4;
    r->d[1] = (uint64_t) (c & 0xFFFFFFFFFFFFFFFFULL);
    c >>= 64;
    c += p2 + (uint128_t)
        p4;
    r->d[2] = (uint64_t) (c & 0xFFFFFFFFFFFFFFFFULL);
    c >>= 64;
    c += p3;
    r->d[3] = (uint64_t) (c & 0xFFFFFFFFFFFFFFFFULL);
    c >>= 64;
#endif
...
SECP256K1_INLINE static void secp256k1_scalar_mul_shift_var(secp256k1_scalar *r,
    ...
    r->d[0] =
        shift < 512 ? (l[0 + shiftlimbs] >> shiftlow | (shift < 448 && shiftlow ? (l[1 + shiftlimbs] << shifthigh) : 0))
                    : 0;
    r->d[1] =
        shift < 448 ? (l[1 + shiftlimbs] >> shiftlow | (shift < 384 && shiftlow ? (l[2 + shiftlimbs] << shifthigh) : 0))
                    : 0;
    r->d[2] =
        shift < 384 ? (l[2 + shiftlimbs] >> shiftlow | (shift < 320 && shiftlow ? (l[3 + shiftlimbs] << shifthigh) : 0))
                    : 0;
